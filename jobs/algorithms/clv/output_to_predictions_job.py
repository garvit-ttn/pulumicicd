...
path_to_files = get_s3_path_for_feature(features.ClvOutput, lake_descriptor, data_filter_context)
print(path_to_files)
...
update_map = {
    ...
    conformed.ProfileAlgorithmsOutput.clv_monetary.column_alias(): "clv.MONETARY",
    conformed.ProfileAlgorithmsOutput.clv_6_months_expected_purchases.column_alias(): "clv.6_MONTHS_EXPECTED_PURCHASES",
    conformed.ProfileAlgorithmsOutput.clv_6_months_clv.column_alias(): "clv.6_MONTHS_CLV",
