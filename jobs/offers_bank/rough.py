...
def map_promotions_to_dynamodb(promo: DataFrame) -> DataFrame:
    ...
    # print("Default Eligible offers for audience after mapping to promotions:" (static_offers.show(truncate=False))
...
if __name__ == '__main__':
    ...
    eligible_offers = map_promotions_to_dynamodb(promotions)
