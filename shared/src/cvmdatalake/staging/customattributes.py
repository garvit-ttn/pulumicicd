...
class CustomAttributes(TableSpec):
    ...
    country_of_residence = ColumnSpec(
        data_type='string',
        description=''
    )
    ...
    enrollment_date = ColumnSpec(
        data_type='string',
        description=''
    )

    enrollment_sponsor = ColumnSpec(
        data_type='string',
        description=''
    )
    ...
    first_share_login_date = ColumnSpec(
        data_type='string',
        description=''
    )
    ...
    last_redemption_date = ColumnSpec(
        data_type='string',
        description=''
    )
    ...
    points_balance = ColumnSpec(
        data_type='string',
        description=''
    )

    points_won_spin_wheel = ColumnSpec(
        data_type='string',
        description=''
    )
    ...
    share_registration_date = ColumnSpec(
        data_type='timestamp',
        description=''
    )
